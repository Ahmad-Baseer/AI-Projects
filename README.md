...
2. Intsall the libraries first before running notebooks. Remove the '#' sign from the lines to allow nltk to download required files & to see everything works fine or not.
...
5. Open up terminal in the same folder and type this command: 'streamlit run Web_App.py'. It will open your application in your default browser.
